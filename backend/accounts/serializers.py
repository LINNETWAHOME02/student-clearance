...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'first_name', 'last_name', 'email', 'id_number', 'role', 'department', 'clearance_type', 'is_active', 'phone', 'avatar', 'bio', 'course', 'year', 'semester', 'admission_date', 'expected_graduation', 'gpa', 'credits', 'position']
